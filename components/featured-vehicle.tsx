...
const rangeRoverImages = [
  "/images/whatsapp-image-2026-01-08-at-5-11-42-pm-1.jpeg", // Front 3/4 view
  "/images/whatsapp-image-2026-01-08-at-5-11-41-pm-2.jpeg", // Front view
  "/images/whatsapp-image-2026-01-08-at-5-11-38-pm-4.jpeg", // Side profile
  "/images/whatsapp-image-2026-01-08-at-5-11-40-pm-3.jpeg", // Front 3/4 different angle
  "/images/whatsapp-image-2026-01-08-at-5-11-39-pm-2.jpeg", // Interior dashboard
  "/images/whatsapp-image-2026-01-08-at-5-11-42-pm-2.jpeg", // Full dashboard view
  "/images/whatsapp-image-2026-01-08-at-5-11-41-pm.jpeg", // Steering wheel close-up
  "/images/whatsapp-image-2026-01-08-at-5-11-41-pm-1.jpeg", // Rear view
  "/images/screenshot-2026-01-08-172905.png", // Interior back seat with sunroof
  "/images/screenshot-2026-01-08-172835.png", // Side profile view
  "/images/screenshot-2026-01-08-172844.png", // Rear 3/4 view
  "/images/screenshot-2026-01-08-172916.png", // Interior front dashboard
  "/images/screenshot-2026-01-08-172952.png", // Center console and screen
  "/images/screenshot-2026-01-08-172804.png", // Rear 3/4 angle
  "/images/screenshot-2026-01-08-172854.png", // Rear seats view
  "/images/screenshot-2026-01-08-172942.png", // Steering wheel with branding
  "/images/screenshot-2026-01-08-172816.png", // Front headlight detail
  "/images/screenshot-2026-01-08-172826.png", // Rear taillight detail
]
...
export function FeaturedVehicle() {
  ...
  const nextSlide = () => {
    ...
    setCurrentIndex((prev) => (prev + 1) % rangeRoverImages.length)
  ...
  const prevSlide = () => {
    if (isTransitioning) return
    setIsTransitioning(true)
    setCurrentIndex((prev) => (prev - 1 + rangeRoverImages.length) % rangeRoverImages.length)
    setTimeout(() => setIsTransitioning(false), 800)
  }
  ...
  return (
    ...
    >
      ...
      <div className="container px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold text-foreground mb-6 animate-glow">Featured Vehicle</h2>
          <p className="text-2xl text-muted-foreground">Premium Range Rover Sport</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            {rangeRoverImages.map((image, index) => (
              <div
                key={index}
                className={cn(
                  ...
                  index === currentIndex
                    ...
                    : index === (currentIndex - 1 + rangeRoverImages.length) % rangeRoverImages.length
          ...
          >
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground text-xl font-medium">Premium Luxury SUV - Pristine Condition</p>

                <div className="pt-6 space-y-3 text-base leading-relaxed text-muted-foreground">
                  <p className="font-bold text-foreground text-xl mb-4">Range Rover Autobiography Sport Edition</p>
                  <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3">
                    ...
                    <p>
                      ...
                      <span className="text-foreground">Petrol</span>
                    </p>
                  </div>
                  ...
                  <div className="pt-4 space-y-2 border-t border-border/50 mt-6">
                    ...
                    <ul className="space-y-2 pl-4">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>LED Headlights with signature DRL</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Wide Panoramic Roof</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Full Leather 8-way electric front seats with power recline rear seats</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
