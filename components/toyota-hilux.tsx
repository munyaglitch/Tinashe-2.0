...
export function ToyotaHilux() {
  ...
  const nextSlide = () => {
    ...
    setCurrentIndex((prev) => (prev + 1) % hiluxImages.length)
  ...
  const prevSlide = () => {
    if (isTransitioning) return
    setIsTransitioning(true)
    setCurrentIndex((prev) => (prev - 1 + hiluxImages.length) % hiluxImages.length)
    setTimeout(() => setIsTransitioning(false), 800)
  }
    ...
    <section ref={sectionRef} className="py-32 bg-gradient-to-b from-card/50 to-background overflow-hidden relative">
      ...
      <div className="container px-4 relative z-10">
        ...
        >
          ...
          <p className="text-2xl text-muted-foreground">Toyota Hilux GD6 DoubleCab</p>
        </div>
              ...
              <div
                ...
                className={cn(
                  ...
                  index === currentIndex
                    ...
                    : index === (currentIndex - 1 + hiluxImages.length) % hiluxImages.length
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
              <div className="space-y-4 flex-1">
                <h3 className="text-4xl font-bold text-foreground bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
                  Toyota Hilux GD6 DoubleCab
                </h3>
                <p className="text-muted-foreground text-xl font-medium">Rugged Reliability - Built to Last</p>

                <div className="pt-6 space-y-3 text-base leading-relaxed text-muted-foreground">
                  <p className="font-bold text-foreground text-xl mb-4">Toyota Hilux GD6 DoubleCab Edition</p>
                  <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3">
                    ...
                    <p>
                      ...
                      <span className="text-foreground">2.8L Diesel</span>
                    </p>
                    <p className="text-accent font-semibold">SA Make</p>
                    <p className="text-primary font-bold text-lg col-span-2">4X4 Package</p>
                  </div>
                  ...
                  <div className="pt-4 space-y-2 border-t border-border/50 mt-6">
                    ...
                    <ul className="space-y-2 pl-4">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Reverse Camera + 360° Dual Cam</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Sparkling Full Fabric Interior</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
