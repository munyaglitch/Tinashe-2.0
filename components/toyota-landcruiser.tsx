...
export function ToyotaLandcruiser() {
  ...
  const nextSlide = () => {
    ...
    setCurrentIndex((prev) => (prev + 1) % toyotaImages.length)
  ...
  const prevSlide = () => {
    if (isTransitioning) return
    setIsTransitioning(true)
    setCurrentIndex((prev) => (prev - 1 + toyotaImages.length) % toyotaImages.length)
    setTimeout(() => setIsTransitioning(false), 800)
  }
  ...
  return (
    <section ref={sectionRef} className="py-32 bg-gradient-to-b from-card/50 to-background overflow-hidden relative">
      ...
      <div className="container px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold text-foreground mb-6 animate-glow">
            Toyota LandCruiser 300 Series
          </h2>
          <p className="text-2xl text-muted-foreground">ZX Edition - The Ultimate Executive SUV</p>
        </div>
              ...
              <div
                ...
                className={cn(
                  ...
                  index === currentIndex
                    ...
                    : index === (currentIndex - 1 + toyotaImages.length) % toyotaImages.length
              ...
              >
                <div className="w-full h-full p-8 md:p-12 flex items-center justify-center">
                  <img
                    ...
                    alt={`Toyota LandCruiser view ${index + 1}`}
          ...
          >
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
              <div className="space-y-4 flex-1">
                ...
                <p className="text-muted-foreground text-xl font-medium">ZX Edition - Executive Luxury SUV</p>

                <div className="pt-6 space-y-3 text-base leading-relaxed text-muted-foreground">
                  <p className="font-bold text-foreground text-xl mb-4">Toyota LandCruiser 300 Series ZX Edition</p>
                  <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3">
                    ...
                    <p>
                      ...
                      <span className="text-foreground">Brand New (Delivery Mileage)</span>
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      <span className="text-foreground">3.3L Turbo Diesel</span>
                    </p>
                  </div>
                  ...
                  <div className="pt-4 space-y-2 border-t border-border/50 mt-6">
                    ...
                    <ul className="space-y-2 pl-4">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Wide Sunroof Installed</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Spacious Executive Vehicle</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Wide Multi Functional Display Unit</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Nice Mags Right Round</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>Rear Entertainment Quality System</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
                        <span>3rd Row Seats</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-1">•</span>
